...
The primary motivation for the development of `primate` was to simplify implicit trace estimation for pure C++ operators that lie inside of other Python packages, and to extend support for Python types implementing [SciPys `LinearOperator`](https://docs.scipy.org/doc/scipy/reference/generated/scipy.sparse.linalg.LinearOperator.html) abstract interface that.
