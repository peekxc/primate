...
- `imate`'s uses runtime-linked shared libraries, wheres `primate`'s is mostly header-only ([comparison](https://stackoverflow.com/questions/12671383/benefits-of-header-only-libraries))
