...
|----------------|----------------------------------------------------------|---------------------------------------------------------------------------|------------|
| `A`            | scipy.sparse.linalg.LinearOperator \| ndarray \| sparray | Symmetric operator to tridiagonalize.                                     | _required_ |
...
| Type          | Description                                                              |
|---------------|--------------------------------------------------------------------------|
| (a,b) : tuple | The diagonal and off-diagonal of the tridiagonal matrix.                 |
| ndarray       | If `return_basis` is True, the orthogonal basis for the Krylov subspace. |
