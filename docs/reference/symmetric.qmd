...
| pd     | bool                                    | Whether to ensure the generated matrix is positive-definite, clipping eigenvalues as necessary. | `True`     |
| ew     | np.ndarray                              | Desired eigenvalues of `A`. If not provided, generates random values in the range [-1, 1].      | `None`     |
