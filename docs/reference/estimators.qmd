...
| Name | Description |
| --- | --- |
| [hutch](#estimators.hutch) | Estimates the trace of a symmetric `A` via the Girard-Hutchinson estimator. |

### hutch { #estimators.hutch }
...
| estimator | Union\[str, ConvergenceEstimator\]      | Type of estimator to use for convergence testing. See details.                    | `'confidence'` |
