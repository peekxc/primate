...
static int __Pyx_ImportFunction_3_0_1(PyObject *module, const char *funcname, void (**f)(void), const char *sig);
...
static void (*__pyx_f_5scipy_6linalg_13cython_lapack_dstev)(char *, int *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, int *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, int *); /*proto*/
...
void lapack_sstev(char *__pyx_v_jobz, int *__pyx_v_n, float *__pyx_v_d, float *__pyx_v_e, float *__pyx_v_z, int *__pyx_v_ldz, float *__pyx_v_work, int *__pyx_v_info) {
...
void lapack_dstev(char *__pyx_v_jobz, int *__pyx_v_n, double *__pyx_v_d, double *__pyx_v_e, double *__pyx_v_z, int *__pyx_v_ldz, double *__pyx_v_work, int *__pyx_v_info) {
  __Pyx_RefNannyDeclarations
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
...
void lapack_sbdsdc(char *__pyx_v_uplo, char *__pyx_v_compq, int *__pyx_v_n, float *__pyx_v_d, float *__pyx_v_e, float *__pyx_v_u, int *__pyx_v_ldu, float *__pyx_v_vt, int *__pyx_v_ldvt, float *__pyx_v_q, int *__pyx_v_iq, float *__pyx_v_work, int *__pyx_v_iwork, int *__pyx_v_info) {
  __Pyx_RefNannyDeclarations
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
...
void lapack_dbdsdc(char *__pyx_v_uplo, char *__pyx_v_compq, int *__pyx_v_n, double *__pyx_v_d, double *__pyx_v_e, double *__pyx_v_u, int *__pyx_v_ldu, double *__pyx_v_vt, int *__pyx_v_ldvt, double *__pyx_v_q, int *__pyx_v_iq, double *__pyx_v_work, int *__pyx_v_iwork, int *__pyx_v_info) {
  __Pyx_RefNannyDeclarations
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
...
static int __pyx_pymod_exec__lapack(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__lapack},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_lapack(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_lapack(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__lapack(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__lapack(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__lapack(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_lapack' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_lapack", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  if (unlikely(!__pyx_m)) __PYX_ERR(0, 1, __pyx_L1_error)
  #elif CYTHON_USE_MODULE_STATE
  __pyx_t_1 = PyModule_Create(&__pyx_moduledef); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  {
    int add_module_result = PyState_AddModule(__pyx_t_1, &__pyx_moduledef);
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to _lapack pseudovariable */
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__lapack(void)", 0);
...
/* FunctionImport */
#ifndef __PYX_HAVE_RT_ImportFunction_3_0_1
#define __PYX_HAVE_RT_ImportFunction_3_0_1
static int __Pyx_ImportFunction_3_0_1(PyObject *module, const char *funcname, void (**f)(void), const char *sig) {
    PyObject *d = 0;
    PyObject *cobj = 0;
    union {
